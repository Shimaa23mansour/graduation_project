...
class AmbulanceVideosPage extends StatefulWidget {
  const AmbulanceVideosPage({Key? key}) : super(key: key);

  @override
  State<AmbulanceVideosPage> createState() => _AmbulanceVideosPageState();
}

class _AmbulanceVideosPageState extends State<AmbulanceVideosPage> {
  ...
  final List<Map<String, String>> videoData = [
    {
      'url': 'assets/ambulance1.mp4',
      'label': 'Neck Injury – Need an Ambulance',
    },
    {'url': 'assets/ambulance2.mp4', 'label': 'Drowning – Call an Ambulance'},
    {
      'url': 'assets/ambulance3.mp4',
      'label': 'Electrical Short Circuit – Ambulance Required',
    },
  ];
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text('Ambulance Videos')),
      body: Padding(
