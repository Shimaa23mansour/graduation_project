...
class FireVideosPage extends StatefulWidget {
  const FireVideosPage({Key? key}) : super(key: key);

  @override
  State<FireVideosPage> createState() => _FireVideosPageState();
}

class _FireVideosPageState extends State<FireVideosPage> {
  ...
  final List<Map<String, String>> videoData = [
    {
      'url': 'assets/fire1.mp4',
      'label': 'House Fire Rescue – Need a Fire Truck',
    },
    {'url': 'assets/fire2.mp4', 'label': 'Emergency – Car Accident'},
    {'url': 'assets/fire3.mp4', 'label': 'Emergency – Gas Leak'},
  ];
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text('Fire Videos')),
      body: Padding(
